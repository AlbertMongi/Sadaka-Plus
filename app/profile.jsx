...
//       if (json.success) {
//         showToast(t('account_deleted_successfully'), 'success');
...
//         } else {
//           showToast(json.message || t('deletion_failed'), 'error');
//         }
//       }
//     } catch (err) {
//       console.error('Delete account error:', err);
//       showToast(t('failed_delete_account_try_again'), 'error');
//     } finally {
//       setDeleting(false);
...
//                  <Text style={styles.offlineTitle}>{t('no_internet_connection')}</Text>
//           <Text style={styles.offlineSubtitle}>
//             {t('profile_auto_load_online')}
//           </Text>
//                 <TouchableOpacity style={styles.retryBtn} onPress={fetchProfile}>
//                      <Text style={styles.retryText}>{t('retry_now')}</Text>
//                 </TouchableOpacity>
//               </Animated.View>
//             </TouchableWithoutFeedback>
//           </View>
...
//                    <Text style={styles.verifiedText}>{t('verified_account')}</Text>
//                 </View>
//               )}
//             </View>
...
//                  <Text style={styles.menuText}>{t('edit_profile_information')}</Text>
//                 <Ionicons name="chevron-forward" size={20} color="#666" />
//               </TouchableOpacity>

//               <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/ChangePasswordScreen')}>
//                 <Ionicons name="key-outline" size={22} color={GOLD} style={styles.menuIcon} />
//                 <Text style={styles.menuText}>{t('change_password.title')}</Text>
//                 <Ionicons name="chevron-forward" size={20} color="#666" />
//               </TouchableOpacity>
//             </View>
...
//                    <Text style={styles.deleteTriggerText}>{t('delete_account')}</Text>
//               </TouchableOpacity>
//             </View>
//           </>
//         )}
...
//                       <Text style={styles.bulletItem}>{t('delete_profile_info')}</Text>
//   <Text style={styles.bulletItem}>{t('delete_transaction_history')}</Text>
//   <Text style={styles.bulletItem}>{t('delete_followed_communities')}</Text>
//                     </View>

//                     <Text style={styles.inputLabel}>
//                {t('enter_password_confirm')}<Text style={{ color: DANGER_RED }}>*</Text>
//                     </Text>
...
const ProfileScreen = () => {
  ...
  const navigation = useNavigation(); // still kept in case used elsewhere
  const router = useRouter();
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          {/* Fixed back button – uses router.back() instead of navigation.goBack() */}
        ...
        {loading ? (
          ...
          <>
            <View style={styles.profileHeader}>
              {/* Empty avatar area – no picture, just placeholder */}
              ...
              {/* <Text style={styles.noPhotoText}>No profile picture set</Text> */}
            </View>
...
const styles = StyleSheet.create({
  ...
  nameText: { fontSize: 22, fontFamily: 'GothamBold', color: '#222', marginBottom: 6 },
  verifiedBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#E8F5E9',
  ...
  verifiedText: { marginLeft: 6, color: '#4CAF50', fontSize: 14, fontFamily: 'GothamMedium' },

  menuGroup: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', marginBottom: 24 },
  menuItem: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 16,
  ...
  menuIcon: { marginRight: 16 },
  menuText: { flex: 1, fontSize: 16, color: '#222', fontFamily: 'GothamMedium' },
  ...
  sheetHandle: { width: 44, height: 5, backgroundColor: '#ddd', borderRadius: 3, alignSelf: 'center', marginBottom: 16 },
  ...
  bulletList: { marginBottom: 28 },
  bulletItem: { fontSize: 15, color: '#444', lineHeight: 24, paddingLeft: 8, marginBottom: 8 },
